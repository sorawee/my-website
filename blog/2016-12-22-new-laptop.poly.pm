...
# this really boosts my productivity
...
Life of Thinkpad in Ubuntu also kinda sucks. Fingerprint reader @link["https://forums.lenovo.com/t5/forums/v3_1/forumtopicpage/board-id/Special_Interest_Linux/thread-id/7920/page/1"]{doesn't work}. Neither are Tablet mode auto-rotation. In fact, I couldn't even connect the accelerometer although I'm sure there is one because it works in Windows. So I need to manually tell Ubuntu to rotate screen, which is kinda awkward. I make it easier by calling this script (which also does other things like disabling trackpad, etc.):
